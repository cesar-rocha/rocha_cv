...
mesoscale to submesocale flows, and the circulation and dynamics of the Brazil Current. 
...
4.\,\textbf{Rocha, C. B.};  Chereskin, T. K.; Gille, S. T. and Menemenlis, D., {in press}: ``Mesoscale to submesoscale wavenumber spectra in Drake Passage''. 

\SmallSep

3.\,\textbf{Rocha, C. B.};  Young, W. R. and Grooms, I., {in press}: ``On Galerkin approximations of the surface-active quasi-geostrophic equations'', \texttt{doi:10.1175/JPO-D-15-0073.1} 
...
1. Oceans and Cryosphere Seminar Series, Jet Propulsion Laboratory, 2015
