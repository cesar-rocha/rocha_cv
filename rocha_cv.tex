...
\begin{flushright}\small
    ...
    \includegraphics[width=.195\textwidth]{theory_comp_obs.png}
\end{flushright}\normalsize
\framebreak
...
%%% About me
\begin{Research}
I combine theory, computation, and observations to study how the ocean flows and shapes the climate.
My motivation stems both from genuine curiosity and the societal relevance
of oceanography in the anthropocene. My latest research efforts have
